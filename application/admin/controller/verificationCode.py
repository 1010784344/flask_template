...
codeBp = flask.Blueprint(name="code",import_name=__name__,url_prefix="/code")

#验证码
@codeBp.route('/imgCode')
def imgCode():
...
class imageCode():
  ...
  def getVerifyCode(self):
    ...
    # 字体
    font = ImageFont.truetype(app.static_folder + r'\public\static\font/Arial.ttf', 40)
    # draw对象
